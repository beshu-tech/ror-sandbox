...
generate_log_documents 1 | index_documents "mandr-logs"
generate_log_documents 1 | index_documents "qim-paloaltonew-logs"
generate_log_documents 1 | index_documents "cipherlogs-logs"
